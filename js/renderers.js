...
export function renderJournalForm(sectionId, entry) {
    ...
    <div class="space-y-2 text-sm">
        ...
        <div class="flex gap-2">
            <input type="text" value="${entry.url || ""}" placeholder="URL" class="flex-1 p-2 bg-gray-600 rounded border border-transparent focus:border-blue-500 focus:outline-none" onchange="updateEntry('${sectionId}', '${entry.id}', 'url', this.value)">
            <input type="text" value="${entry.urlText || "Link"}" placeholder="Link text" class="w-24 p-2 bg-gray-600 rounded border border-transparent focus:border-blue-500 focus:outline-none" onchange="updateEntry('${sectionId}', '${entry.id}', 'urlText', this.value)">
        </div>
        ...
        <textarea placeholder="Description" class="w-full p-2 bg-gray-600 rounded h-24 border border-transparent focus:border-blue-500 focus:outline-none" onchange="updateEntry('${sectionId}', '${entry.id}', 'description', this.value)">${entry.description || ""}</textarea>
    </div>
    `;
}
...
export function renderEventForm(sectionId, entry) {
    ...
    <input type="text" value="${entry.place || ""}" placeholder="City, Country" class="w-full p-2 bg-gray-600 rounded border border-transparent focus:border-blue-500 focus:outline-none" onchange="updateEntry('${sectionId}', '${entry.id}', 'place', this.value)">
    <input type="text" value="${entry.venue || ""}" placeholder="Venue" class="w-full p-2 bg-gray-600 rounded border border-transparent focus:border-blue-500 focus:outline-none" onchange="updateEntry('${sectionId}', '${entry.id}', 'venue', this.value)">
...
export function renderMediaForm(sectionId, entry) {
    return `<div class="space-y-2 text-sm">
      ...
      <input type="text" value="${entry.creator || ""}" placeholder="Creator/Host" class="w-full p-2 bg-gray-600 rounded border border-transparent focus:border-blue-500 focus:outline-none" onchange="updateEntry('${sectionId}', '${entry.id}', 'creator', this.value)">
      <input type="text" value="${entry.url || ""}" placeholder="URL" class="w-full p-2 bg-gray-600 rounded border border-transparent focus:border-blue-500 focus:outline-none" onchange="updateEntry('${sectionId}', '${entry.id}', 'url', this.value)">
      <textarea placeholder="Description" class="w-full p-2 bg-gray-600 rounded h-20 border border-transparent focus:border-blue-500 focus:outline-none" onchange="updateEntry('${sectionId}', '${entry.id}', 'description', this.value)">${entry.description || ""}</textarea>
    </div>`;
}
